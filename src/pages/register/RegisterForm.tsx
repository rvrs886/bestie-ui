            ...
            <Paper bg={alpha("white", 0.20)} shadow="lg" p="xl" radius="md">
                ...
                <form onSubmit={registerForm.onSubmit((values) => console.log(values))}>
                    <Flex gap="sm" w="18vw" pb="xs" direction="column">
                        <Box>
                            <InputLabel c="white" size="md">First name</InputLabel>
                            <TextInput
                                withAsterisk
                                size="md"
                        ...
                        <Box>
                            <InputLabel c="white" size="md">Last name</InputLabel>
                            <TextInput
                                withAsterisk
                                size="md"
                        ...
                        <Box>
                            <InputLabel c="white" size="md">Phone number</InputLabel>
                            <TextInput
                                size="md"
                                withAsterisk
                        ...
                        <Box>
                            <InputLabel c="white" size="md">Repeat password</InputLabel>
                            <TextInput
                                size="md"
                                withAsterisk
